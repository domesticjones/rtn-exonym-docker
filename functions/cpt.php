...
function cpt_quotes() {
	$labels = array(
		...
		'featured_image'        => __( '', 'quotes' ),
		'set_featured_image'    => __( '', 'quotes' ),
		'remove_featured_image' => __( '', 'quotes' ),
		'use_featured_image'    => __( '', 'quotes' ),
		'insert_into_item'      => __( '', 'quotes' ),
		'uploaded_to_this_item' => __( '', 'quotes' ),
